            ...
            <div className="flex flex-col items-stretch lg:flex-row">
                ...
                <div className="pt-8 lg:w-1/2 lg:pl-20 lg:pr-12 lg:pt-0">
                    ...
                    <div className="flex justify-center lg:block">
                        <Link to="/signup" className="mb-12 inline-block rounded bg-[#0f4c81] px-[12px] py-[8px] text-lg font-medium text-white hover:bg-[#093558]">
                            {t('about.cta')}
                        </Link>
                    </div>
                    <div className="flex items-center">
                        ...
                        <div>
                            ...
                            <p className="mb-2 inline text-lg text-[#212529]">{t('about.testimonial.quote')}</p>
                            <i className="fa-sharp fa-solid fa-quote-right relative -top-2 ml-1" aria-hidden="true"></i>
                            <p>
                                <span className="font-semibold text-[#212529]">{t('about.testimonial.name')}</span>
                                <span className="pl-2 font-semibold text-[#0f4c81]">{t('about.testimonial.position')}</span>
                            </p>
                        </div>
                    </div>
                </div>
